            ...
            "
                ...
                @if (request()->is('extra/*/edit') || request()->is('extra/create'))
                    <div class="form-floating mb-3">
                        <select class="form-select @error('worksheet_id') is-invalid @enderror" name="worksheet" id="worksheet" disabled>
                        ...
                        @error('worksheet_id')
                            <div class="invalid-feedback d-block">
                                Munkalap megadása kötelező
                            </div>
                        @enderror
                    </div>
                    <div class="form-floating mb-3">
                        <select class="form-select @error('computer_id') is-invalid @enderror" name="computer" id="computer" disabled>
                ...
                @csrf
                <div class="form-floating mb-3">
                    <input class="form-control @error('manufacturer') is-invalid @enderror" id="manufacturer" name="manufacturer" type="text"
                        placeholder="Gyártó"
                        value="{{ old('manufacturer', $computer->manufacturer ?? ($extra->manufacturer ?? '')) }}" />
                    <label for="manufacturer">Gyártó</label>
                    @error('manufacturer')
                        <div class="invalid-feedback d-block">
                            Gyártó megadása kötelező
                        </div>
                    @enderror
                </div>
                <div class="form-floating mb-3">
                    <input class="form-control @error('type') is-invalid @enderror" id="type" name="type" type="text" placeholder="Típus"
                ...
                <div class="form-floating mb-3">
                    <input class="form-control @error('serial_number') is-invalid @enderror" id="serial_number" name="serial_number" type="text"
